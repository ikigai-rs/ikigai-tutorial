...
- [Two ways to reach a kernel](modules/two-ways.md)
- [The callback](modules/the-callback.md)
- [A module, end to end](modules/end-to-end.md)
- [The wire session](modules/wire-session.md)
